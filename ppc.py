...
def api_signal_level_stats():
    """Totales por nivel de señal (C1/C2/C3) de todas las enviadas a Telegram:
    ganadas en intento 1, ganadas en intento 2 y perdidas por nivel."""
